...
Route::get('/admin-profile', [AdminDashboardController::class, 'profile'])->middleware('admin');
Route::post('/update-admin', [AdminDashboardController::class, 'update_admin'])->middleware('admin');
